// UTILISATION DU HOOK USE EFFECT DANS LE CADRE D'UN LOADER LOCAL :
...
// 	useEffect(() => {
// 		const idAsInt = Number.parseInt(id ?? "0");
...
// COMPOSANT TRANSFORME SUR A L'UTILISATION DU LOADER GLOBAL DANS MAIN.TSX :
